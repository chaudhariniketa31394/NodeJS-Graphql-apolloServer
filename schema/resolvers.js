...
const resolvers = {
    Query: {
        async repoList() {
            const apiResponse = await axios.get(`https://api.github.com/users/${owner}/repos`)
            return apiResponse.data;

        },
         async repoDetails() {
            const apiResponse = await axios.get(`https://api.github.com/repos/${owner}/node-inverisify-repository-pattern`)
            const repoContest = await axios.get(`https://api.github.com/repos/${owner}/node-inverisify-repository-pattern/contents`)
